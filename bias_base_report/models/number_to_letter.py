...
MONEDAS = (
    {'country': u'Colombia', 'currency': 'COP', 'singular': u'PESO', 'plural': u'PESOS', 'symbol': u'$', 'decimalsingular':u'Centavo','decimalplural':u'Centavos'},
    {'country': u'Estados Unidos', 'currency': 'USD', 'singular': u'DÓLAR', 'plural': u'DÓLARES', 'symbol': u'US$', 'decimalsingular':u'Centavo','decimalplural':u'Centavos'},
    {'country': u'El Salvador', 'currency': 'USD', 'singular': u'DÓLAR', 'plural': u'DÓLARES', 'symbol': u'US$', 'decimalsingular':u'Centavo','decimalplural':u'Centavos'},
    {'country': u'Europa', 'currency': 'EUR', 'singular': u'EURO', 'plural': u'EUROS', 'symbol': u'€', 'decimalsingular':u'Céntimo','decimalplural':u'Céntimos'},
    {'country': u'México', 'currency': 'MXN', 'singular': u'PESO', 'plural': u'PESOS', 'symbol': u'$', 'decimalsingular':u'Centavo','decimalplural':u'Centavos'},
    {'country': u'Perú', 'currency': 'PEN', 'singular': u'NUEVO SOL', 'plural': u'NUEVOS SOLES', 'symbol': u'S/.', 'decimalsingular':u'Centavo','decimalplural':u'Centavos'},
    {'country': u'Reino Unido', 'currency': 'GBP', 'singular': u'LIBRA', 'plural': u'LIBRAS', 'symbol': u'£', 'decimalsingular':u'Centavo','decimalplural':u'Centavos'}
)
    ...
    if mi_moneda != None:
        try:
            ...
            if int(number) == 1:
                ...
                print 'entero', entero
                print "round(float(number) - int(number), 2) == float(0.01)", round(float(number) - int(number), 2) == float(0.01)
